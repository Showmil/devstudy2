            ...
            <CartStyle>
                <div className="content">
                    ...
                    <form className="delivery">
                        ...
                        {errors.address && <p
                            className="error-text">주소를 입력해 주세요.</p>}
                        ...
                        {errors.addressDetail && <p
                            className="error-text">상세 주소를 입력해 주세요.</p>}
                        ...
                        {errors.receiver && <p
                            className="error-text">수령인을 입력해 주세요.</p>}
                        ...
                        {errors.contact && <p
                            className="error-text">전화번호를 입력해 주세요.</p>}
